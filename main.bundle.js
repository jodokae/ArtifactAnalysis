...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.httpClient.get('assets/MvW-Analysis/textFiles/02.merged/Merged.json').subscribe(function (json) {
            _this.odAsJson = json;
            setTimeout(function () {
                _this.selectedOd = new __WEBPACK_IMPORTED_MODULE_1_art_viz_shared_dist_out_tsc__["Objectdiagram"]('02.merged/Merged.od', 'assets/MvW-Analysis/02.merged/Merged.od', true, 'assets/MvW-Analysis/02.merged/Merged.json');
            }, 0);
        });
    };
